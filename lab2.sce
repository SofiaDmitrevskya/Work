n = 3.4; // разница в скорости между катером береговой охраны и лодкой браконьеров
k = 10; // начальное расстояние между катером береговой охраны и лодкой браконьеров
fi=3*%pi/4;
